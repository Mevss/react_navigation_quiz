...
export function Home() {
  ...
  const resetTerms = async () => {
    try {
      await AsyncStorage.removeItem('hasSeenTerms');
      console.log('Terms reset');
      alert('Reset completed! Restart the app to see the Terms screen.');
    } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity onPress={resetTerms}>
          <Text style={styles.footerButton}>Reset!</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
